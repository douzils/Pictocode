...
class MainWindow(QMainWindow):
    ...
    def apply_preferences(self):
        ...
        pen = QColor(settings.value("colors/pen", "#000000"))
        self.canvas.set_background_color(bg)
        self.canvas.set_grid_color(grid)
        self.canvas.set_pen_color(pen)
        self.toolbar.set_color(pen)
        self.canvas.set_grid_size(int(settings.value("grid/size", 50)))
        self.canvas.set_show_grid(settings.value("grid/show", "true") == "true")
        self.canvas.set_snap_to_grid(settings.value("grid/snap", "false") == "true")
